    ...
    <div class="max-w-md w-full bg-white shadow-lg rounded-lg p-8">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-4">
                ...
                <x-text-input id="uid"
                    class="block mt-1 w-full border-gray-300 rounded-md px-4 py-2 bg-black-50 text-black focus:outline-none focus:ring-2 focus:ring-indigo-500"
            ...
            <div class="mb-4">
                ...
                <x-text-input id="name"
                    class="block mt-1 w-full border-gray-300 rounded-md px-4 py-2 bg-gray-50 text-black focus:outline-none focus:ring-2 focus:ring-indigo-500"
