    ...
    <nav class="p-4 space-y-4">
        ...
        <div>
            ...
            <a href="{{ route('admin.requests.index') }}"
                class="{{ request()->routeIs('admin.requests.*') ? 'w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium bg-blue-100 text-gray-900' : 'w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium text-gray-900' }}">
            ...
            <a href="{{ route('admin.category.index') }}"
                ...
                จัดการหมวดหมู่
                @cannot('admin')
                <span class="ml-auto text-xs text-gray-400">(ดูอย่างเดียว)</span>
                @endcannot
            </a>
