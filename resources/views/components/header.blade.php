...
<header class="bg-white shadow-sm border-b  border-gray-200 ">
            ...
            <div class="pt-4 border-t border-gray-200">
                @auth
                    <div class="flex items-center justify-between mb-3">
                        <button
                            class="mobile-user-dropdown-toggle flex items-center font-medium text-gray-700 hover:text-gray-900 transition-colors">
                    ...
                    <div class="mobile-user-dropdown-content space-y-2">
                        ...
                        @if(!auth()->user()->verificationRequest || auth()->user()->verificationRequest->status !== 'approved')
                            <a href="{{ route('verification.index') }}"
                                class="flex items-center px-3 py-2 text-sm text-orange-700 hover:bg-orange-50 rounded-md">
    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-4 mb-4">
            <!-- Breadcrumb -->
            <nav class="flex items-center text-xs sm:text-sm text-gray-500 space-x-1 overflow-x-auto breadcrumb-nav"
