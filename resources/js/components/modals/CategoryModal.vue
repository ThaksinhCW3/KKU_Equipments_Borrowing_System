    ...
    <div class="flex min-h-full items-center justify-center p-4">
      <div
        ...
        <div class="p-6 overflow-y-auto flex-1 min-h-0">
          ...
          <div v-if="mode === 'view' && category" class="space-y-6">
            ...
            <div v-if="categoryEquipments.length > 0" class="pt-4 border-t border-gray-200">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div v-for="equipment in categoryEquipments" :key="equipment.id"
          ...
          <!-- Edit/Create Mode -->
          <form v-else-if="mode === 'edit' || mode === 'create'" id="category-form" @submit.prevent="onSave" novalidate
            class="space-y-6">
            <!-- Basic Information -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <!-- Left Column -->
              <div class="space-y-4">
                ...
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-1">
                    ชื่อหมวดหมู่ <span class="text-red-500 ml-1">*</span>
                  </label>
        ...
        <div class="flex items-center justify-end space-x-3 p-6 border-t border-gray-200 bg-gray-50">
          ...
          <button v-if="mode === 'edit' || mode === 'create'" type="submit" form="category-form"
...
export default {
  ...
  watch: {
    isOpen(newVal) {
      if (newVal) {
        ...
        // reset validation UI whenever modal opens
  ...
  methods: {
    ...
    onSave() {
      ...
      const saveData = { name: this.form.name };
    ...
    validateField(field) {
      ...
      switch (field) {
        case 'name':
          this.validationErrors.name = val && String(val).trim() ? '' : 'กรุณากรอกชื่อหมวดหมู่';
          break;
        default:
          break;
      }
    ...
    async loadCategoryEquipments() {
      ...
      if (this.allEquipments && this.allEquipments.length > 0) {
        this.categoryEquipments = this.allEquipments.filter(equipment => {
          return equipment.categories_id == this.category.id ||
    ...
    getStatusClass(status) {
      switch (status) {
        ...
        case "unavailable": return "bg-gray-200 text-gray-600";
    ...
    getStatusLabel(status) {
      switch (status) {
        ...
        case "unavailable": return "ถูกยืม";
        case "retired": return "รอคืน";
