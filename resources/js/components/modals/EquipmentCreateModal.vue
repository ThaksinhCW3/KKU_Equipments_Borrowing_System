    ...
    >
        <div class="bg-white rounded-lg shadow-lg w-11/12 sm:w-2/3 md:w-1/2 lg:w-2/5 xl:w-1/3 p-6 max-h-[90vh] overflow-y-auto my-4 mx-auto">
            ...
            <form @submit.prevent="onCreate" novalidate>
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 font-semibold mb-1">อุปกรณ์ที่ติดมากับเครื่อง</label>
                ...
                <div class="flex justify-end space-x-2">
                    ...
                    <button type="submit" class="px-4 py-2 rounded bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-60 flex items-center justify-center"
