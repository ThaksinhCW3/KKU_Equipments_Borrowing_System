...
class VerificationRequestAutoRejected extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->when($this->verificationRequest && $this->verificationRequest->created_at, function ($mail) {
                return $mail->line("วันที่ส่งคำขอ: " . $this->verificationRequest->created_at->format('d/m/Y'));
            })
    ...
    public function toDatabase($notifiable)
    {
        return [
            ...
            'extra' => [
                ...
                'submitted_at' => $this->verificationRequest && $this->verificationRequest->created_at ? $this->verificationRequest->created_at->format('Y-m-d') : null,
